                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        ...
                        <div class="flex items-center justify-between mt-auto">
                            <div class="flex items-baseline gap-2">
                                <span class="font-headline-sm text-lg text-secondary font-bold">₹{{ number_format($displayPrice) }}</span>
                                @if($salePrice && $price > $salePrice)
                                    <span class="text-xs text-slate-400 line-through">₹{{ number_format($price) }}</span>
                                @endif
                            </div>
