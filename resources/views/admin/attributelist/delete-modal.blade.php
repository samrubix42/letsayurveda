<div x-data="{ deleteOpen: false }"
    ...
    <div x-show="deleteOpen"
         class="relative bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden z-10 border border-slate-200"
        ...
        <div class="p-6 space-y-4 text-center">
            ...
            <p class="text-sm text-slate-500">
                Are you sure you want to delete this variant attribute? This action cannot be undone. All associated values and option linkages will also be deleted.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 border-t border-slate-100 bg-slate-50/50 px-6 py-4">
            ...
            <button wire:click="deleteAttribute" type="button" class="bg-rose-600 hover:bg-rose-700 text-white font-semibold text-xs tracking-wider px-6 py-2.5 rounded-full hover:shadow-md active:scale-95 transition-all cursor-pointer">
                DELETE ATTRIBUTE
            </button>
        </div>
    </div>
