<div x-data="{ animating: false }" class="max-w-5xl mx-auto space-y-6">
    ...
    {{-- PAGE HEADER --}}
    <div>
        <h1 class="font-headline-sm text-3xl font-bold text-slate-800 tracking-tight">Update Product</h1>
        <p class="text-sm text-slate-500 mt-1">Modify details for: <span class="font-bold text-emerald-600">{{ $product->name }}</span></p>
    </div>
