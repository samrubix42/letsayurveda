    ...
    <div x-show="deleteOpen"
        ...
        <div class="p-6 space-y-4 text-center">
            ...
            <p class="text-sm text-slate-500">
                Are you sure you want to delete this discount coupon? This action cannot be undone. Customers will no longer be able to apply this code at checkout.
            </p>
        </div>
        ...
        <div class="flex items-center justify-end gap-3 border-t border-slate-100 bg-slate-50/50 px-6 py-4">
            ...
            <button wire:click="deleteCoupon" type="button" class="bg-rose-600 hover:bg-rose-700 text-white font-semibold text-xs tracking-wider px-6 py-2.5 rounded-full hover:shadow-md active:scale-95 transition-all cursor-pointer">
                DELETE COUPON
            </button>
        </div>
    </div>
