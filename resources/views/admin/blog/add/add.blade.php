<div class="space-y-6 animate-fade-in-up">
    ...
    <div class="flex flex-col gap-2">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mt-2">
            <div>
                <h1 class="font-headline-sm text-3xl font-bold text-slate-800 tracking-tight">Write New Blog</h1>
                <p class="text-sm text-slate-500 mt-1">Formulate wellness stories and ayurvedic teachings.</p>
            </div>
        </div>
    </div>
